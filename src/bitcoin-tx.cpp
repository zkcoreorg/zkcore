...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("zkCore zkcore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zkcore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zcash transaction") + "\n" +
              "  zkcore-tx [options] -create [commands]   " + _("Create hex-encoded zcash transaction") + "\n" +
              "\n";
